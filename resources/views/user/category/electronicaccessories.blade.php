...
<html>
<head>
  <title>GiveApp | Electronic Accessories</title>
</head>
...
<div class="wrapper">
        ...
        <div class="card-deck">
            <div class="card">
                <img class="card-img-top" src="/images/categories/electronicaccessories/1.jpg" alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card">
                <img class="card-img-top" src="/images/categories/electronicaccessories/2.jpg" alt="Card image cap">
        <div class="card-body">
        ...
        <div class="card">
                <img class="card-img-top" src="/images/categories/electronicaccessories/3.jpg" alt="Card image cap">
        <div class="card-body">
