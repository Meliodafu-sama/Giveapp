...
<html>
<head>
  <title>GiveApp | Fashion Accessories</title>
</head>
...
<body>
  <nav class="navbar navbar-dark bg-primary">
    <a class="navbar-brand" href="">GiveApp</a>
    <form class="form-inline my-2 my-lg-0">
      <button type="button" class="btn btn-primary"><a href="/user/profile">Profile</a></button>
      <button type="button" class="btn btn-primary"><a href="/Giveapp.com">Log Out</a></button>
    </form>
  </nav>
