...
<html>
<head>
  <title>GiveApp | Electronic Devices</title>
</head>
...
<div class="wrapper">
        ...
        <div class="card-deck">
            <div class="card">
                <img class="card-img-top" src="/images/categories/electronicdevices/1.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Mac Book Air</h5>
                    <p class="card-text">Not Being Used</p>
                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
            </div>
            </div>
        <div class="card">
                <img class="card-img-top" src="/images/categories/electronicdevices/2.jpg" alt="Card image cap">
        <div class="card-body">
        ...
        <div class="card">
                <img class="card-img-top" src="/images/categories/electronicdevices/3.jpg" alt="Card image cap">
        <div class="card-body">
                <h5 class="card-title">Laptop</h5>
                <p class="card-text">Have a small scrath but doesn't affect the performance</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        </div>
        </div>
        </div>
